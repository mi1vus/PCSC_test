...
namespace MiFare.PcSc.MiFareStandard
{
    ...
    public class LoadKey : LoadKeys
    {
        ...
        public LoadKey(byte[] mifareKey, byte keySlotNumber, LoadKeysStorageType KeyType)
            : base(LoadKeysKeyType.CardKey, null, LoadKeysTransmissionType.Plain, KeyType/*GetLoadKeysType()*/, keySlotNumber, mifareKey)
